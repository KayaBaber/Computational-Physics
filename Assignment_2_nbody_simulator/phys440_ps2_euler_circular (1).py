...
def nbody_sim_euler(posArray,velArray, massArray,stepSize,stepCount):
    ...
    for i in range(stepCount):
        ...
        historicEngDrift.append((energy-energyStart)/energyStart)
        #print ang, energy
        #print velArray[1]
...
historicPosArray,historicAngMomenDrift, historicEngDrift = nbody_sim_euler(posArray,velArray,massArray,stepSize,stepCount)
